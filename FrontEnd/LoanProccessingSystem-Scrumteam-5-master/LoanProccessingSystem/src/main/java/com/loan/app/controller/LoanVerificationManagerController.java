...
import io.swagger.annotations.ApiOperation;
 ...
 public class  LoanVerificationManagerController {
		...
		public String homeRequest() {
			return "Welcome :  Loan verification Application"; //returns String value
		}

		
		@ApiOperation(value="PUT mapping for the loan Verification to update the status of application",response= LoanVerificationManagerController.class)
